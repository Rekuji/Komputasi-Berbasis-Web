...
<div class="row">
  ...
  <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
    <div class="photo-card">
      <img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(73).webp" alt="Photo" class="clickable-image">
      <div class="photo-overlay">
        ...
        <div class="icons">
          @if(Auth::check())
            <a href="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(73).webp" download class="btn btn-sm btn-primary position-absolute bottom-0 end-0 m-2">Download</a>
          @else
    ...
    <div class="photo-card">
      <img src="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain1.webp" alt="Photo" class="clickable-image">
      <div class="photo-overlay">
        <div class="profile-info">
          <img src="{{ asset('/storage/cactus (10).jpeg') }}" alt="Profile">
          <span>Rexzy Febriano</span>
  ...
  <div class="col-lg-4 mb-4 mb-lg-0">
    ...
    <div class="photo-card">
      <img src="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain2.webp" alt="Photo" class="clickable-image">
      <div class="photo-overlay">
        <div class="profile-info">
        ...
        <div class="icons">
          @if(Auth::check())
            <a href="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain2.webp" download class="btn btn-sm btn-primary position-absolute bottom-0 end-0 m-2">Download</a>
          @else
            <a href="{{ route('login') }}" class="btn btn-sm btn-primary position-absolute bottom-0 end-0 m-2">Login to Download</a>
          @endif
        </div>
  ...
  <div class="col-lg-4 mb-4 mb-lg-0">
    ...
    <div class="photo-card">
      <img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(18).webp" class="clickable-image"/>
      <div class="photo-overlay">
        <div class="profile-info">
        ...
        <div class="icons">
          @if(Auth::check())
            <a href="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(18).webp" download class="btn btn-sm btn-primary position-absolute bottom-0 end-0 m-2">Download</a>
          @else
            <a href="{{ route('login') }}" class="btn btn-sm btn-primary position-absolute bottom-0 end-0 m-2">Login to Download</a>
          @endif
        </div>
    ...
    <div class="photo-card">
      <img src="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain3.webp" alt="Yosemite National Park" class="clickable-image"/>
      <div class="photo-overlay">
        <div class="profile-info">
          <img src="{{ asset('/storage/cloud (1).jpeg') }}" alt="Profile">
          <span>Shavalino Fayola</span>
  ...
  <div class="d-flex justify-content-center align-items-center">
    <a href="{{ route('explore') }}" class="btn btn-primary btn-lg">See More</a>
  </div>
</div>
<!-- Gallery -->  
